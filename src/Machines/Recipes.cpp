...
constexpr std::array<CraftRecipe, 32> craftRecipes = {{
    ...
    {ItemType::CopperPickaxe,   {{{ItemType::Stick, 2}, {ItemType::CopperPlate, 10}}},  2.0f, true},
    {ItemType::CopperAxe,       {{{ItemType::Stick, 2}, {ItemType::CopperPlate, 5}}},   2.0f, true},
    {ItemType::IronPickaxe,     {{{ItemType::Stick, 2}, {ItemType::IronPlate, 10}}},    2.0f, true},
    {ItemType::IronAxe,         {{{ItemType::Stick, 2}, {ItemType::IronPlate, 5}}},     2.0f, true},
    {ItemType::ObsidianPickaxe, {{{ItemType::Stick, 2}, {ItemType::Obsidian, 10}}},      2.0f, true},
    {ItemType::ObsidianAxe,     {{{ItemType::Stick, 2}, {ItemType::Obsidian, 5}}},       2.0f, true},
